...
<body>
  ...
  for ($i = 0; $i < $count; $i++) {
    ...
    echo "<form action='modificaDB.php' method='post'>
              <div class='products products-table'>
                <div class='product'>
                  ...
                  <div class='product-content'>
                    ...
                    <input style='margin-top: 10px; color: white;' type='number' step='.01' placeholder='Insert price to modify' name='prezzo' required>
